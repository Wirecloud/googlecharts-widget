...
(function () {
    ...
    describe("Google Charts widget", function () {
        ...
        it("handles correctly events comming from the input endpoint (passing type, options and data)", function () {
            ...
            //callback('{"type":"ComboChart"}');
            //callback('{"options":{"width":"100%","height":"100%"}}');
            //callback('{"data":[["Country","Popularity"],["Germany",200],["United States",300],["Brazil",400],["Canada",500],["France",600],["RU",700]]}');
